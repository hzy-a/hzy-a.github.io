...
$.ajax({
  ...
  data: {
    key: 'P6FBZ-2JZWG-DJGQB-Q2IUE-ZDRBJ-NQF6B',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(113.58761666, 37.86236085, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by hzy %c 你正在访问hzyの小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| hzy") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('Hzy的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://api.r10086.com/%E5%9B%BE%E5%8C%85webp/%E5%8A%A8%E6%BC%AB%E7%BB%BC%E5%90%8815/0072Vf1pgy1foxlhe0a6tj31hc0u0qhh.webp)" class="imgbox" onclick="changeBg('url(https://api.r10086.com/%E5%9B%BE%E5%8C%85webp/%E5%8A%A8%E6%BC%AB%E7%BB%BC%E5%90%8815/0072Vf1pgy1foxlhe0a6tj31hc0u0qhh.webp)')"></a></div>
              </div>
            </details>
